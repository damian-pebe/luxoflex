    ...
    <div  >
      <div className="  flex flex-col justify-center items-center h-screen">
        ...
        <h1 className="text-5xl font-orbitron mb-5 text-center bg-gradient-to-r from-white via-gray-200 to-gray-100 text-transparent bg-clip-text  transform  transition-transform duration-300 ease-in-out">
          LUXOFLEX
          <span className="block text-2xl text-gray-300 mt-4 font-light tracking-wider">
            Esta página no fue encontrada o hubo algun error
          </span>
          <span className="block text-xl text-gray-400 mt-2 font-light tracking-wider animate-pulse">
            404 - Page Not Found
          </span>
        </h1>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-300 mb-4 animate-pulse">
            Te invitamos a seguir descubriendo nuestros servicios
          </p>
          <Link
            className="inline-block px-8 py-3 text-xl font-orbitron text-white border-2 border-white rounded-lg hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105"
            to="/"
          >
            Volver al inicio
          </Link>
...
const TvNotFound = () => (
  <StyledWrapper>
    <div className="main_wrapper hover:cursor-grab z-50" >
      <div className="main">
