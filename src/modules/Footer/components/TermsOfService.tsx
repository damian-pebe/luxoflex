            ...
            <section className="col-span-2">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">No debe utilizar el servicio para fines ilegales o no autorizados.</p>
                </div>
                <div>
                  <h4 className="font-medium">Contenido del Usuario</h4>
                  <p className="text-sm text-gray-600">Es responsable de todo el contenido que publique o transmita a través del servicio.</p>
                </div>
                <div>
                  <h4 className="font-medium">Terminación</h4>
                  <p className="text-sm text-gray-600">Podemos terminar o suspender su acceso inmediatamente, sin previo aviso, por cualquier razón.</p>
                </div>
              </div>
            </section>
          </div>
