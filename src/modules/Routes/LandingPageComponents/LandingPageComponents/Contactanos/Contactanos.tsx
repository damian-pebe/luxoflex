      ...
      <div className="sm:hidden block">
        <div className=" grid grid-cols-5 gap-10 justify-center ">
          <PinContainer
            ...
            className="flex-grow"
          >
            <div className="flex basis-full flex-col p-2 tracking-tighter text-slate-100/50 sm:basis-1/2 w-[5rem] h-[8rem] ">
              <h3 className="max-w-xs !pb-1 !m-0 font-extralight font-zilla  text-base text-slate-100">
                Email
              </h3>
              {/* <div className="text-xs !m-0 !p-0 font-normal">
    ...
    <div className="flex gap-4 items-center justify-center p-20">
      <Popover content="Email">
        <i
          ...
          className="hover:cursor-pointer bi bi-envelope-at text-3xl transition-all duration-1000 hover:text-red-700 hover:scale-150"
        ></i>
      </Popover>
      ...
      <Popover content="Llamar">
        <i
          ...
          className="hover:cursor-pointer bi bi-telephone-outbound text-3xl transition-all duration-1000 hover:text-gray-600 hover:scale-150"
        ></i>
      </Popover>
      ...
      <Popover content="WhatsApp">
        <i
          ...
          className="hover:cursor-pointer bi bi-whatsapp text-3xl transition-all duration-1000 hover:text-green-700 hover:scale-150"
        ></i>
      </Popover>
      ...
      <Popover content="Facebook">
        <i
          ...
          className="hover:cursor-pointer bi bi-facebook text-3xl transition-all duration-1000 hover:text-blue-400 hover:scale-150"
        ></i>
      </Popover>
      ...
      <Popover content="Instagram">
        <i
          ...
          className="hover:cursor-pointer bi bi-instagram text-3xl transition-all duration-1000 hover:text-pink-700 hover:scale-150"
        ></i>
      </Popover>
    </div>
  );
