...
import { CarouselProps } from "./models/Models";
        ...
        {carouselItems.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div className={`z-10 ${round ? "p-0 m-0" : "mb-4 p-5"}`}>
                <span className="flex h-[28px] w-[28px] items-center justify-center rounded-full bg-[#060606]">
                  {item.icon}
                </span>
              </div>
              <div className="p-5">
                <div className="text-left mb-1 font-black text-2xl lg:text-5xl text-white">
                  {item.title}
                </div>
                <p className="text-lg lg:text-2xl text-left text-white">{item.description}</p>
              </div>
            </motion.div>
          );
        })}
