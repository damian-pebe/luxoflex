    ...
    const items = [
        {
            ...
            description: "Descubre productos de alta calidad respaldados por expertos apasionados. Tu satisfacción es nuestra prioridad.",
            header: <Body />,
        ...
        },
        {
            ...
            description: "Nuestro equipo dedicado te guiará en cada paso, asegurando que encuentres exactamente lo que necesitas.",
            header: <Body />,
        ...
        },
        {
            ...
            description: "Respaldamos cada producto con nuestra garantía de satisfacción. Tu confianza es nuestro mayor valor.",
            header: <Body />,
            className: "md:col-span-1 hover:scale-[1.02] transition-all duration-300",
        ...
        },
        {
            ...
            description: "Disfruta de una experiencia de compra excepcional con atención personalizada y productos de primera clase.",
            header: <Body />,
            className: "md:col-span-2 hover:scale-[1.02] transition-all duration-300",
        ...
        },
        {
            ...
            description: "Siempre a la vanguardia con las últimas tendencias y tecnologías para ofrecerte lo mejor del mercado.",
            header: <Body />,
            className: "md:col-span-2 hover:scale-[1.02] transition-all duration-300",
        ...
        },
        {
            ...
            description: "Estamos aquí para ayudarte antes, durante y después de tu compra. Tu satisfacción es nuestra misión.",
            header: <Body />,
            className: "md:col-span-1 hover:scale-[1.02] transition-all duration-300",
